...
def parse_arguments():
    ...
    parser.add_argument("--valid_path", default="../data/dev_100M_tokenized.bin", type=str, help="Path to the validation data.")
    parser.add_argument("--name", default="base_15-16_babylm_100M", type=str, help="Name of the run.")
    ...
    parser.add_argument("--local_batch_size", default=128, type=int, help="Batch size for training per GPU.")
