...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_path', type=str, default="/Users/suchirsalhan/Documents/PHD/PHD/gpt-bert-main/data/combined.txt", help='Specify the input filename')
    parser.add_argument('--vocab_path', type=str, default="/Users/suchirsalhan/Documents/PHD/PHD/gpt-bert-main/tokenizers/tokenizer_70M.json", help='Specify the output filename')
    ...
    def iterator(file_path: str):
        for line in tqdm(open(file_path, encoding="utf-8")):
            line = line.strip()
            if len(line) == 0:
                continue
            yield line
